...
const tasksOption: Option[] = [
  {
    key: 'collection-data',
    sourcePath: '../src/resource/collection-data',
    targetPath:
      '../../../blueprint-templates/crud-collection-resource/__kebabCase_name__',
  },
  {
    key: 'single-data',
    sourcePath: '../src/resource/single-data',
    targetPath:
      '../../../blueprint-templates/crud-single-resource/__kebabCase_name__',
  },
]
...
async function main() {
  ...
  console.log(`\n apps/api-server 全部任務結束：${new Date()}`)
